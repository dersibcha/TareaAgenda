...
function crearPager(dataJson){
    registros=dataJson.length;
    if(registros>=10){
    var j=(registros - (registros % 10))/10;
    }else{j=1;}
    
   $("#pagination").html(""); 
   
   $("#pagination").append("<li class='previous'><button class='btn btn-small btn-primary' type='button'>&larr;</button></li>");
    ...
    for(var i=0;i<j;i++){
        r1=i*10;
        r2=r1+10-1;
        var li="<li ><button class='btn btn-small btn-primary' type='button' class='active' id='p"+(i+1)+"' onclick='dibujarTabla("+dataJson+","+r1+","+r2+");' >"+(i+1)+"</button></li>";
   
        $("#pagination").append(li);
    
      
    }
     $("#pagination").append("<li class='next'><button class='btn btn-small btn-primary' type='button'>&rarr;</button></li>");
}
...
function dibujarTabla(dataJson, i,j) {
